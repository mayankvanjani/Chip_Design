...
% Last Modified by GUIDE v2.5 23-Apr-2018 17:16:10
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Sum=handles.led1+(2)*handles.led2+(2^2)*handles.led3+(2^3)*handles.led4+(2^4)*handles.led5+(2^5)*handles.led6+(2^6)*handles.led7+(2^7)*handles.led8;
success_wirein=calllib('okFrontPanel', 'okFrontPanel_SetWireInValue', handles.xem, hex2dec('00'),Sum,hex2dec('FF'));
